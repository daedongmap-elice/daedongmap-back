...
VALUES
    ('서울 강남구 대치동 996-16','한식','27531028','02-558-7905','중앙해장','http://place.map.kakao.com/27531028','서울 강남구 영동대로86길 17','127.065472540916','37.508273597195', 5),
    ('서울 강동구 성내동 442-12','간식','18310200','1588-5678','백년화편','http://place.map.kakao.com/18310200','서울 강동구 양재대로81길 32','127.065472540919','37.508273597184',2),
    ('서울 강북구 수유동 56-45','일식','16380488','02-2241-7558','다래함박스텍','http://place.map.kakao.com/16380488','서울 강북구 수유로 20-2','127.019032803713','37.6327573067632',3.5),
    ('서울 마포구 망원동 485-33', '한식', '18208683', '02-323-2366', '고기도국수면', 'http://place.map.kakao.com/m/18208683', '서울 마포구 동교로9길 95 1층 101호', '37.55754586036254', '126.90773850090908', 4.5),
    ('서울 마포구 망원동 485-5', '양식', '16993977', '02-6497-1517', '따식갈비&파스타', 'http://place.map.kakao.com/m/16993977', '서울 마포구 월드컵로 23길 12', '37.557298269687756', '126.90797364662406', 4),
    ('서울 마포구 망원동 379-25', '일식', '1226420399', '070-7773-9870', '헤키', 'http://place.map.kakao.com/m/1226420399', '서울 마포구 동교로 9길 33', '37.555213869163104', '126.90979829468023', 5),
    ...
    ('대구 서구 내당동 884-11','한식','21315532','053-552-5040','푸른회식당','http://place.map.kakao.com/21315532','대구 서구 달구벌대로375길 14-1','128.570128289469','35.8622283847847',3),
    ...
    ('인천 남동구 간석동 130-12','한식','11057071','032-425-5538','부암갈비','http://place.map.kakao.com/11057071','인천 남동구 용천로 149','126.714336437057','37.46304021542',4),
    ...
    ('경기 용인시 수지구 고기동 593-4','한식','83147987','031-263-1107','고기리막국수','http://place.map.kakao.com/83147987','경기 용인시 수지구 이종무로 157','127.04009695074139','37.359995701236684',4),
    ('경기 수원시 팔달구 인계동 958-1','한식','8108863','1600-3883','가보정 1관','http://place.map.kakao.com/8108863','경기 수원시 팔달구 장다리로 282','127.02870636847084','37.274117855078806',3),
    ('경기 남양주시 별내동 719-2','간식','1684848518','0507-1328-5719','보나리베','http://place.map.kakao.com/1684848518','경기 남양주시 불암산로39번길 9-2','127.10685334966008','37.6470198906585',3),
    ('경기 용인시 수지구 동천동 115-3','한식','267054429','031-263-6823','산으로간고등어','http://place.map.kakao.com/267054429','경기 용인시 수지구 고기로 126','127.09037998227228','37.34764821072656',4),
    ('경기 수원시 영통구 망포동 322-3','간식','19539402','031-205-0031','하얀풍차제과 망포역점','http://place.map.kakao.com/19539402','경기 수원시 영통구 영통로 195','127.05573176779723','37.2452478188161',3),
    ('경기 의정부시 장암동 98-23','양식','1580065362','0507-1403-9211','파크프리베','http://place.map.kakao.com/1580065362','경기 의정부시 동일로192번길 28-27','127.06098318998117','37.70623422358499',3.5),
    ('경기 시흥시 정왕동 2030-11','한식','27331019','031-319-5227','청춘조개 본점','http://place.map.kakao.com/27331019','경기 시흥시 오이도로 199-1','126.68709741439','37.3430350027099',3),

    ('충북 청주시 청원구 우암동 131-4','한식','16507806','','봉용불고기','http://place.map.kakao.com/16507806','충북 청주시 청원구 중앙로 108','127.48840295237417','36.64674658915036',3),
    ...
    ('전남 목포시 무안동 1-3','간식','9466320','061-244-0885','코롬방제과점','http://place.map.kakao.com/9466320','전남 목포시 영산로75번길 7','126.38441612105967','34.789851685791895',4),
    ...
    ('전북특별자치도 전주시 완산구 다가동3가 68','술집','1544371560','063-231-5210','다가양조장','http://place.map.kakao.com/1544371560','전북특별자치도 전주시 완산구 전주객사1길 5','127.140366942663','35.8168760098398',4.5),
    ...
    ('강원특별자치도 강릉시 초당동 354-4','간식','3222543','','순두부젤라또 1호점','http://place.map.kakao.com/3222543','강원특별자치도 강릉시 초당순두부길 95-5','128.9154797999827','37.79168654379332',3.5),
...
VALUES
    ...
    (2, 2, 2, 2, 16380488, '옛날 돈가스 그 맛. 정성 가득한 함박 스테이크.', 2, '2024-05-01 11:13:10.03', '2024-05-01 11:13:10.03'),
    (5, 5, 5, 5, 16380488, '맛있습니다. 6000원에 곱배기 해서 1500원 추가. 7500원에 이정도 퀄이라니.', 3, '2024-05-01 12:13:10.03', '2024-05-01 12:13:10.03'),
    (4, 5, 3, 4, 83147987, '이 주변 막국수 원탑. 가는길 상태가 영 좋진 않지만 맛있어요. 꾸준히 찾는 곳.', 4, '2024-05-02 12:13:10.03', '2024-05-02 12:13:10.03'),

    (4, 2, 5, 5, 83147987, '몇년을 다녀도 질이 절대로 떨어지지않는 맛집! 혼밥러 클리어 하고 나왔습니다! 조만간 친구들이랑 다시 간다.', 6, '2024-05-02 13:13:10.03', '2024-05-02 13:13:10.03'),
    (5, 5, 5, 5, 83147987, '여기는 감칠맛을 잘냄. 손님이 그렇게 많은데도 매장관리도 착실하다', 7, '2024-05-02 14:13:10.03', '2024-05-02 14:13:10.03'),
    (3, 5, 3, 1, 83147987, '들기름, 비빔 다 좋다영!', 1, '2024-05-02 15:13:10.03', '2024-05-02 15:13:10.03'),
    ...
    (2, 2, 2, 2, 18310200, '밥알 찹살떡이 이리도 맛있다니요~^^ 늘 잘먹고 있네요~!', 3, '2024-05-04 17:13:10.03', '2024-05-04 17:13:10.03'),
    (3, 4, 3, 2, 16507806, '음 현지인들이 왜 많이 오는지 모르겠다 맛은 평범', 6, '2024-05-05 17:13:10.03', '2024-05-05 17:13:10.03'),
    (4, 4, 4, 4, 11057071, '고기 양이 좀 적고 가게가 오래되서 지저분하다 느꼈는데 맛있긴함 ', 4, '2024-05-05 17:13:10.03', '2024-05-05 17:13:10.03'),
    ...
    (4, 4, 4, 4, 1544371560, '아 ㅋㅋㅋ진짜 소문대로 안주가 미친듯이 나와요 배터질것같아서 도망쳤어요', 7, '2024-05-05 17:13:10.03', '2024-05-05 17:13:10.03'),
    (3, 3, 3, 3, 1580065362, '정원이 넓어 시원하고 산책하기도 좋네요', 2, '2024-05-06 17:13:10.03', '2024-05-06 17:13:10.03'),

    (4, 5, 3, 4, 1580065362, '비가와서 만끽하진 못했지만 야외공간이 너무 멋집니다 커피도 번도 맛있돠~~', 1, '2024-05-06 17:13:10.03', '2024-05-06 17:13:10.03'),
    (4, 4, 4, 4, 267054429, '부모님께서 너무나 좋아하시니!!!', 8, '2024-05-06 17:13:10.03', '2024-05-06 17:13:10.03'),
    (4, 4, 4, 4, 18208683, '그렇게 맛있다고 들었는데 의심했으나.. 진짜 존맛이네 ㅋㅋ', 2, '2024-05-06 17:13:10.03', '2024-05-06 17:13:10.03'),
    ...
    (3, 4, 2, 3, 8108863, '너무 좋고 아주 맛있고!', 5, '2024-05-06 17:13:10.03', '2024-05-06 17:13:10.03');
    (3, 3, 3, 3, 1684848518, '너무 좋네요!!', 5, '2024-05-06 17:13:10.03', '2024-05-06 17:13:10.03');
    (3, 1, 5, 3, 19539402, '강추드립니다!', 5, '2024-05-06 17:13:10.03', '2024-05-06 17:13:10.03');
    (3, 2, 4, 3, 27331019, '재방문 의사 있습니다!', 5, '2024-05-06 17:13:10.03', '2024-05-06 17:13:10.03');
...
VALUES
    ...
    ('2024-05-06 17:13:10.03', '2024-05-06 17:13:10.03', 29, 5, '따식1', 'https://daedongmap-bucket.s3.ap-northeast-2.amazonaws.com/review/%E1%84%84%E1%85%A1%E1%84%89%E1%85%B5%E1%86%A81.jpeg'),
    ('2024-05-06 17:13:10.03', '2024-05-06 17:13:10.03', 30, 5, '따식1', 'https://daedongmap-bucket.s3.ap-northeast-2.amazonaws.com/review/%E1%84%84%E1%85%A1%E1%84%89%E1%85%B5%E1%86%A81.jpeg'),
    ('2024-05-06 17:13:10.03', '2024-05-06 17:13:10.03', 31, 5, '따식1', 'https://daedongmap-bucket.s3.ap-northeast-2.amazonaws.com/review/%E1%84%84%E1%85%A1%E1%84%89%E1%85%B5%E1%86%A81.jpeg'),
    ('2024-05-06 17:13:10.03', '2024-05-06 17:13:10.03', 32, 5, '따식1', 'https://daedongmap-bucket.s3.ap-northeast-2.amazonaws.com/review/%E1%84%84%E1%85%A1%E1%84%89%E1%85%B5%E1%86%A81.jpeg');
